...
#include <sys/time.h>
//#include "data.h"
#include "/esat/puck1/users/nshah/cpu_openmp/tretail_TWO_WAY_PARTITION_TWO_WAY_FULL_CPU_FINE_2.c"
...
int par_for(int n_iter, int batch_sz, int N_for_threads, int N_layers, int *layer_len, int tot_layer_len, 
            int * cum_layer_len,
...
int main(int argc, char *argv[]) {
  ...
  printf("per_inference,%fs,", delta/(n_iter*batch_sz));
}
